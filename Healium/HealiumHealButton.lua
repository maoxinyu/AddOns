...
function Healium_HealButton_OnEnter(frame, motion)
	...
	elseif (stype == "macro") then 
		...
		GameTooltip:SetText("|cFFFFFFFFNo Spell|n|cFF00FF00You may drag-and-drop a spell from your|nspellbook onto this button, or you may go|nto Game Menu, Addons, " ..Healium_AddonName .. " and|nselect your spells from the list.")
    end
...
local function Drag(frame)
	...
	Healium_DebugPrint("infoType:", infoType, "info1:", info1, "info2", info2)
