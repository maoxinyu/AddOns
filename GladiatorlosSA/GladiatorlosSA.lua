...
function GladiatorlosSA:OnInitialize()
	...
	if (IsAddOnLoaded("GladiatorlosSA")) then		--bf@178.com
		self:ADDON_LOADED("ADDON_LOADED", "GladiatorlosSA");
	else
