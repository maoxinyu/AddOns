...
function Coords:OnEnable()
	if not display then
		...
		cursortext:SetPoint("TOPLEFT", WorldMapFrame.ScrollContainer, "BOTTOM", 30, 15)		-- bf@178.com
		playertext:SetPoint("TOPRIGHT", WorldMapFrame.ScrollContainer, "BOTTOM", -30, 15)	-- bf@178.com
