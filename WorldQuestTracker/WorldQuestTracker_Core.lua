...
WorldQuestTracker.OnToggleWorldMap = function (self)
	...
	if (WorldMapFrame:IsShown()) then
		...
		--]=]
			...
			ToggleQuestsButton.TextLabel = DF:CreateLabel (ToggleQuestsButton, L["Toggle World Quests"], DF:GetTemplate ("font", "WQT_TOGGLEQUEST_TEXT"))
			...
			ToggleQuestsSummaryButton.TextLabel = DF:CreateLabel (ToggleQuestsSummaryButton, L["Toggle Summary"], DF:GetTemplate ("font", "WQT_TOGGLEQUEST_TEXT"))
			...
			function worldSummary.UpdateFactionAnchor()
				...
				factionAnchor:SetPoint ("bottomright", WorldQuestTrackerGoToAllianceButton, "topleft", 0, WorldQuestTracker.db.profile.bar_anchor == "top" and -31 or -15)
			end			
			...
			function worldSummary.CreateFactionButtons()
				...
				local buttonOnEnter = function (self)
					...
					GameCooltip:AddLine ("Click: select this faction", "", 1, "orange", "orange", 9)
					GameCooltip:AddLine ("Shift + Click: track this faction quests", "", 1, "orange", "orange", 9)
			...
			local BuildTimeLeftMenu = function()
				...
				GameCooltip:AddLine (L["No Priority by Time Left"])
			...
			local BuildOptionsMenu = function() -- �ptions ~options
				...
				--show by
					GameCooltip:AddLine (L["Summary by Map"], "", 2)
					...
					GameCooltip:AddLine (L["Summary by Quest Type"], "", 2)
				...
				GameCooltip:AddLine ("$div", nil, 2, nil, -7, -14)
					...
					GameCooltip:AddLine (L["Increase Squares per Row"], "", 2)
					...
					GameCooltip:AddLine (L["Decrease Squares per Row"], "", 2)
				...
				--show the summary in the left side of the world map
					...
					GameCooltip:AddLine (L["Anchor to Left Side"], "", 2)
					...
					GameCooltip:AddLine (L["Anchor to Right Side"], "", 2)
				...
				do
					...
					GameCooltip:AddLine (L["Don't Show if Already in Group"], "", 2)
