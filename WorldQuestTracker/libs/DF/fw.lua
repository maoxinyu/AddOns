...
function DF:ReskinSlider (slider, heightOffset)
	if (slider.slider) then
		...
		slider.cima:SetBackdrop ({edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1, bgFile = [[Interface\AddOns\WorldQuestTracker\images\background]]})
		...
		slider.baixo:SetBackdrop ({edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1, bgFile = [[Interface\AddOns\WorldQuestTracker\images\background]]})
		slider.baixo:SetBackdropColor (0, 0, 0, 0.35)
		slider.baixo:SetBackdropBorderColor (0, 0, 0, 1)
		
		slider.slider:SetBackdrop ({edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1, bgFile = [[Interface\AddOns\WorldQuestTracker\images\background]]})
		...
		slider.slider.thumb:SetTexture ([[Interface\AddOns\WorldQuestTracker\images\icons2]])
