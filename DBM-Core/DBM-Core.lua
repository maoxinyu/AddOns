...
DBM = {
	...
	DisplayVersion = "8.0.15 alpha", -- the string that is shown as version
	ReleaseRevision = 18052 -- the revision of the latest stable version that is available
}
...
DBM.DefaultOptions = {
	...
	CountdownVoice3v2 = "VP:Yike",				--bf@178.com
