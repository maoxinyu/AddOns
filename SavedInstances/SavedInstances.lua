...
addon.defaultDB = {
  ...
  Tooltip = {
    ReverseInstances = true,	-- bf@178.com
    ShowExpired = true,			-- bf@178.com
    ShowHoliday = true,
    ShowRandom = true,
    CombineWorldBosses = true,	-- bf@178.com
    CombineLFR = true,
    TrackDailyQuests = true,
    TrackWeeklyQuests = true,
    ShowCategories = true,		-- bf@178.com
    CategorySpaces = true,		-- bf@178.com
    RowHighlight = 0.1,
    Scale = 1,
    FitToScreen = true,
    NewFirst = true,
    ...
    ShowSoloCategory = true,	-- bf@178.com
    ShowHints = true,
    ReportResets = true,
    LimitWarn = true,
    HistoryText = true,			-- bf@178.com
    ShowServer = false,
    ServerSort = true,
    ServerOnly = false,
